...
# Define functions
# =============================================================================
def mask_from_polygons(xarr, yarr, polygons, polygons_in, include_holes=True):
  """
...
def count_objects_inside(polygons, xarr, yarr, polygons_in=None, include_holes=True):
    """
